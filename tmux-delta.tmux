...
status_fmt0="#{S/n:#[fg=${C_SURFACE0}]#[bg=default]${SEP_L}#[fg=${C_FG} bg=${C_SURFACE0}]#{?#{==:#{@session_type},folder},󰉋,#{?#{==:#{@session_type},worktree},󰘬,󰊢}} #{?#{@session_label},#{@session_label},#{session_name}}#{?#{@pr_icons}, #{@pr_icons},}#{?#{@agent_working}, #[fg=${C_PEACH}]󰚩#[fg=${C_FG}],} #[fg=${C_SURFACE0}]#[bg=default]${SEP_R}#[fg=default bg=default] ,#[fg=${C_MAUVE}]#[bg=default]${SEP_L}#[fg=${C_CRUST} bg=${C_MAUVE}]#{?#{==:#{@session_type},folder},󰉋,#{?#{==:#{@session_type},worktree},󰘬,󰊢}} #{?#{@session_label},#{@session_label},#{session_name}}#{?#{@pr_icons}, #{@pr_icons},}#{?#{@agent_working}, #[fg=${C_PEACH}]󰚩#[fg=${C_CRUST}],} #[fg=${C_MAUVE}]#[bg=default]${SEP_R}#[fg=default bg=default] }#[align=right]#{E:status-right}"
