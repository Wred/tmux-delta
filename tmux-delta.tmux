...
tmux set-option -g 'status-format[0]' '#{S/n:#[fg=#{@thm_surface_0}]#[bg=default]#{@catppuccin_status_left_separator}#[fg=#{@thm_fg} bg=#{@thm_surface_0}] #{?#{==:#{@session_type},folder},󰉋,#{?#{==:#{@session_type},worktree},,󰊢}} #{?#{@session_label},#{@session_label},#{session_name}}#{?#{@pr_icons}, #{@pr_icons},}#{?#{@agent_working}, #[fg=#{@thm_peach}]󰚩#[fg=#{@thm_fg}],} #[fg=#{@thm_surface_0}]#[bg=default]#{@catppuccin_status_right_separator}#[fg=default bg=default] ,#[fg=#{@thm_mauve}]#[bg=default]#{@catppuccin_status_left_separator}#[fg=#{@thm_crust} bg=#{@thm_mauve}] #{?#{==:#{@session_type},folder},󰉋,#{?#{==:#{@session_type},worktree},,󰊢}} #{?#{@session_label},#{@session_label},#{session_name}}#{?#{@pr_icons}, #{@pr_icons},}#{?#{@agent_working}, #[fg=#{@thm_peach}]󰚩#[fg=#{@thm_crust}],} #[fg=#{@thm_mauve}]#[bg=default]#{@catppuccin_status_right_separator}#[fg=default bg=default] }#[align=right]#{E:status-right}'
